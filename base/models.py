...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, username, name, bio, password, **other_fields):
        ...
        return self.create_user(email, username, name, bio, password, **other_fields)

    def create_user(self, email, username, name, bio, password, **other_fields):

        if not email:
            raise ValueError("You must provide an email.")

        email = self.normalize_email(email)
        user = self.model(email=email, username=username, name=name, bio=bio,
                           **other_fields)
